    ...
    if (subBtn && subMenu) {
        ...
        menuItem.addEventListener("mouseenter", () => {
            ...
            document
                ...
                .forEach((b) => b.classList.remove("active_theme_3"));
            document
                .querySelectorAll(".dropdown")
                .forEach((icon) => icon.classList.remove("rotate"));
            document
                .querySelectorAll(".menu > .item > .side_nav")
                .forEach((el) => el.classList.remove("active_theme_3"));
            document
                .querySelectorAll(".sub-item")
                .forEach((el) => el.classList.remove("active_theme_3"));

            subMenu.classList.add("open");
            subBtn.classList.add("active_theme_3");
            dropdownIcon?.classList.add("rotate");
        });

        menuItem.addEventListener("mouseleave", () => {
            subMenu.classList.remove("open");
            subBtn.classList.remove("active_theme_3");
        ...
        menuItem.addEventListener("mouseenter", () => {
            ...
            if (sideNav) {
                sideNav.classList.add("active_theme_3");
            }
        });
        ...
        menuItem.addEventListener("mouseleave", () => {
            const sideNav = menuItem.querySelector(".side_nav");
            if (sideNav) {
                sideNav.classList.remove("active_theme_3");
            }
        });
    }
});
...
document.querySelectorAll(".sub-menu .sub-item").forEach((subItem) => {
    subItem.addEventListener("click", (e) => {
        ...
        subItem.classList.add("active_theme_3");
    });
});
...
document
    ...
    .forEach((link) => {
        link.addEventListener("click", () => {
            document
                .querySelectorAll(".menu > .item > .side_nav")
                .forEach((a) => a.classList.remove("active_theme_3"));
            document
                .querySelectorAll(".sub-item")
                .forEach((el) => el.classList.remove("active_theme_3"));

            link.classList.add("active_theme_3");
        });
    });
