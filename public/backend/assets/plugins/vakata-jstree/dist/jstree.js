	...
	(function ($) {
		...
		$.vakata.context = {
			...
			_show_submenu : function (o) {
				...
				if(right_to_left) {
					o[x - (w + 10 + o.outerWidth()) < 0 ? "addClass" : "removeClass"]("vakata-context-start");
				}
				else {
					o[x + w > dw  && xl > dw - x ? "addClass" : "removeClass"]("vakata-context-end");
				}
				if(y + h + 10 > dh) {
					e.css("bottom","-1px");
				}
				...
				if (o.hasClass('vakata-context-end')) {
					if (xl < w) {
