    ...
    var tpl = {
        "font-styles": function (locale, options) {
            ...
            return "<li class='dropdown'>" +
                    "<a class='btn wysi-btn dropdown-toggle" + size + "' data-bs-toggle='dropdown' href='#'>" +
        ...
        "link": function (locale, options) {
            ...
            return "<li>" +
                    ...
                    "<a href='#' class='btn btn-inverse' data-bs-dismiss='modal'>" + locale.link.cancel + "</a>" +
        ...
        "color": function (locale, options) {
            var size = (options && options.size) ? ' btn-' + options.size : '';
            return "<li class='dropdown'>" +
                    "<a class='btn wysi-btn dropdown-toggle" + size + "' data-bs-toggle='dropdown' href='#' tabindex='-1'>" +
