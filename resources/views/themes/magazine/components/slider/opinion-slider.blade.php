<section class="border p-2 2xl:p-3 rounded-md dark:bg-neutral-900 dark:divide-neutral-700 dark:border-neutral-800 shadow-sm ">
  <div class="flex justify-between items-center gap-2 mb-4">
    <p class="text-theme-three dark:text-cyan-600 dark:hover:text-cyan-500 transition_3 text-lg font-semibold uppercase inline-block">
      {{ localize('opinion') }}
    </p>
    ...
    <div class="swiper-wrapper">
      ...
      @foreach ($opinions->chunk(2) as $opinionChunk)
        <div class="swiper-slide">
          <div
            class="bg-white dark:bg-neutral-900 border-t border-t-neutral-300 dark:border-neutral-700 divide-y dark:divide-neutral-700">
            <!-- Opinion List -->
              ...
              <div class="flex items-center gap-4 py-4">
                ...
                <div class="space-y-3">
                  ...
                  <a href="{{ __url($opinion->encode_title) }}"
                    class="text-base leading-6 font-semibold line-clamp-2 text-theme-three hover:text-cyan-600 dark:hover:text-cyan-600 dark:text-gray-200 transition_3">
                    {{ $opinion->title }}
                  </a>

                  <!-- Name -->
                  <p class="text-cyan-600 text-sm">{{ $opinion->name }}</p>
                </div>
              </div>
            @endforeach
          </div>
