...
@endphp
<section class="bg-white dark:bg-theme-six-secondary shadow-md hidden xl:block fixed_top_menu">
    <div class="container flex justify-between items-center gap-4 relative py-2">
        <div class="hidden lg:block side-bar">
            <div class="menu flex items-center gap-3">
                <div class="item relative cursor-pointer py-2">
                    <a class="capitalize text-theme-six-primary flex justify-start items-center hover:transition_3 side_nav_fashion"
                    ...
                    @if ($menu->submenus->isNotEmpty())
                        <div class="item cursor-pointer py-2">
                            <a href="{{ __url($menu->slug) }}"
                                class="sub-btn text-theme-six-primary flex justify-start items-center hover:transition_3 hover:text-theme-six-primary active:text-theme-six-primary side_nav_fashion">{{ Str::upper($menu->menu_level) }}
                                        ...
                                        @foreach ($menu->submenus as $submenu)
                                            @if ($loop->iteration == 1)
                                                <a href="{{ __url($menu->slug) }}"
                                                    ...
                                                    class="sub-item block my-1 text-base hover:text-theme-six-primary dark:hover:text-theme-six-primary text-theme-six-primary dark:text-theme-six-primary transition_3">
                                                    {{ localize('all') }}
                                                </a>
                                            @endif
                                            <a href="{{ __url($submenu->slug) }}" type="button"
                                                data-tab="{{ Str::slug($submenu->menu_level, '_') }}"
                                                class="sub-item block my-1 text-base hover:text-theme-six-primary dark:hover:text-theme-six-primary text-gray-800 dark:text-white transition_3">
                                                {{ $submenu->menu_level }}
                                            </a>
                                        @endforeach
                                    </div>
                                                            ...
                                                            <div class="overflow-hidden px-2">
                                                                ...
                                                                <div class="p-2 space-y-2">
                                                                    <div class="line-clamp-2">
                                                                        <a href="{{ __url($item->encode_title) }}"
                                                                            class="text-neutral-800 dark:text-white dark:hover:text-theme-six-primary font-bold text-lg leading-6 transition_3 hover:text-theme-six-primary">
                                                                            {{ $item->title }}
                                                                        </a>
                                                                    </div>
                                                                    <div
                    ...
                    @if ($allRssFeeds->count() > 1)
                        ...
                        <div class="item cursor-pointer py-2">
                            <a href="{{ __url('rss-news') }}"
                                class="sub-btn text-theme-six-primary flex justify-start items-center hover:transition_3 hover:text-theme-six-primary active:text-theme-six-primary side_nav_fashion">
                ...
                @if (isset($allVedioNews) && $allVedioNews->isNotEmpty())
                    <div class="item cursor-pointer py-2">
                        <a href="{{ __url('videos') }}"
                            class="sub-btn text-theme-six-primary flex justify-start items-center hover:transition_3 hover:text-theme-six-primary active:text-theme-six-primary side_nav_fashion">{{ Str::upper(localize('video')) }}
                                    ...
                                    <div class="overflow-hidden px-2">
                                        <figure class="relative w-full h-36 2xl:h-48 group overflow-hidden block">
                                            ...
                                            <a href="{{ __url($video->encode_title) }}"
                                                class="bg-neutral-800/20 hover:border-theme-six-primary text-white hover:text-theme-six-primary transition_3 border w-12 h-12 rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex justify-center items-center group">
                                                <span
                                                    class="absolute inline-flex h-full w-full group-hover:animate-ping rounded-full group-hover:bg-theme-six-primary opacity-75"></span>
                ...
                <div class="item cursor-pointer py-2 relative">
                    <a
                        class="sub-btn text-theme-six-primary flex justify-start items-center hover:transition_3 hover:text-theme-six-primary active:text-theme-six-primary side_nav_fashion">{{ Str::upper(localize('more')) }}
                    ...
                    <div
                        class="sub-menu overflow-hidden max-h-0 transition-max-height duration-300 ease-in-out bg-white dark:bg-neutral-800 absolute top-full left-0 w-max shadow-md z-20 dark:text-white">
                            ...
                            @foreach ($pageMenus as $page)
                                @if ($page->pagesubmenus->isNotEmpty())
                                    <li class="py-2 isolate relative overflow-hidden inner_menu">
                                        <div
                                            class="px-3 hover:text-theme-six-primary transition_3 flex gap-3 justify-between items-center text-nowrap">
                                            {{ $page->menu_level }}
                                            <span class="rtl:scale-x-[-1]">
                                                <svg class="absolute lg:relative right-0 transition_3 lg:ml-1 rtl:lg:mr-1 rtl:lg:ml-auto dropdown"
                                                    width="16" height="16" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <ul
                                            ...
                                            @foreach ($page->pagesubmenus as $submenu)
                                                ...
                                                <li class="py-2">
                                                    <a class="px-3 block hover:text-theme-six-primary transition_3 text-nowrap"
