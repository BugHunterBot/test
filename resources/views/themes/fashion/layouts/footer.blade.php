<footer class="relative w-full h-max isolate @if (!$themeSettings->footer_color || mode()) bg-theme-six-secondary @endif"
    ...
    <div class="container py-8">
        @include ('themes.fashion.components.common.footer-heading')

        <section
            class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 xl:gap-0 border-y border-y-theme-six-primary/50 py-8 lg:divide-x lg:rtl:divide-x-reverse lg:divide-theme-six-primary/50">
            <!--  {/* Address Section */} -->
                ...
                <form id="subscribe-form" class="relative my-6 max-w-xl mx-auto">
                    ...
                    <div class="relative">
                        ...
                        <button type="submit" id="subscribe-btn"
                            class="absolute top-1/2 -translate-y-1/2 right-0 rounded-r-md bg-theme-six-primary text-white px-4 h-full flex items-center justify-center gap-1 transition-all duration-300 ease-in">
                            {{ localize('subscribe') }}
                        </button>
                    </div>
                </form>
