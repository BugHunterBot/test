    ...
    <section class="container mt-16 lg:my-6">
        ...
        <div class="dark:text-white bg-neutral-100 dark:bg-neutral-800 flex items-center p-2 gap-3">
            <ul class="flex gap-1 items-center">
                <li>
                    <a class="text-neutral-600 dark:text-white  capitalize transition_3 whitespace-nowrap" href="/news365">Home</a>
                </li>
                ...
                <li>
                    <a class="text-neutral-600 dark:text-white  capitalize transition_3 whitespace-nowrap" href="/sports">Setting</a>
                </li>
                    <svg width="12" height="14" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11 1L1 15" stroke="oklch(70.8% 0 0)" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 my-4 lg:my-10  2xl:gap-16 space-y-4 lg:space-y-0 lg:gap-4">
                ...
                <div class="col-span-4">
                    {{-- update profile --}}
                    @include('themes.times.components.home.setting.update-profile')

                    {{-- change password --}}
                    @include('themes.times.components.home.setting.change-password')

                    {{-- delete account --}}
                    @include('themes.times.components.home.setting.delete-account')
                </div>
        </div>
