    ...
    <section class="container mt-16 lg:my-6">
        ...
        <div class="dark:text-white bg-neutral-100 dark:bg-neutral-800 flex items-center p-2 gap-3">
            <ul class="flex gap-1 items-center">
                ...
                <li>
                    <a class="text-brand-primary capitalize transition_3 line-clamp-1" href="{{ __url('account/settings') }}"> Account
                        Settings</a>
                </li>
            </ul>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 my-4 lg:my-10  2xl:gap-16 space-y-4 lg:space-y-0 lg:gap-4">
            ...
            <div class="col-span-4">
                ...
                @endif
                {{-- update profile --}}
                @include('themes.classic.components.home.setting.update-profile')

                {{-- delete account --}}
                @include('themes.classic.components.home.setting.delete-account')
            </div>
        </div>
