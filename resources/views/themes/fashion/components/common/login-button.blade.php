    ...
    @else
        ...
        <div class="flex divide-x rtl:divide-x-reverse">
            <button type="button" id="openModal"
                class="px-2 text-white hover:text-theme-six-secondary dark:hover:text-theme-six-secondary transition_3">
                {{ localize('login') }}
            </button>
            <a href="{{ __url('registration') }}"
                class="pl-2 rtl:pl-0 rtl:pr-2 text-white hover:text-theme-six-secondary dark:hover:text-theme-six-secondary transition_3">
