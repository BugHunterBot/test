<footer class="relative w-full h-max isolate @if (!$themeSettings->footer_color || mode()) bg-theme-four @endif"
    @if (!mode() && $themeSettings->footer_color) style="background-color: {{ $themeSettings->footer_color }};" @endif>
    <div class="container py-8">
        @include ('themes.times.components.common.footer-heading')

        <section
            class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 xl:gap-0 border-y border-y-blue-950 py-8 lg:divide-x lg:rtl:divide-x-reverse lg:divide-blue-950">
            <!--  {/* Address Section */} -->
                ...
                <form id="subscribe-form" class="relative my-6 max-w-xl mx-auto">
                    ...
                    <div class="relative">
                        ...
                        <button type="submit" id="subscribe-btn"
                            class="absolute top-1/2 -translate-y-1/2 right-0 rounded-r-md bg-blue-800 text-white px-4 h-full flex items-center justify-center gap-1 transition-all duration-300 ease-in">
                            {{ localize('subscribe') }}
                        </button>
                    </div>
                </form>
