    ...
    @else
        <div class="flex gap-2 items-center">
            <button type="button" id="openModal_" onclick="closeSidebar()"
                class="text-white bg-theme-three transition_3 px-6 py-2 rounded-md">
                {{ localize('login') }}
            </button>
            <a href="{{ __url('registration') }}" class="text-white bg-theme-three transition_3 px-6 py-2 rounded-md">
