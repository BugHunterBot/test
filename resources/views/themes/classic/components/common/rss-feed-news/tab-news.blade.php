<section data-content="{{ $rssTabData['slug'] }}" class="global_tab_pane opacity-0 translate-y-4 absolute top-0 left-0 w-full transition-all duration-500 pointer-events-none grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
