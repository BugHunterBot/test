...
@endphp
<section class="@if (!$themeSettings->background_color || mode()) bg-theme-five-primary @endif hidden xl:block fixed_top_menu"
        ...
        <div class="side-bar">
            <div class="menu flex items-center gap-2 xl:gap-4">
                <div class="item relative cursor-pointer py-2">
                    <a class="capitalize flex justify-start items-center side_nav_gazette"
                    ...
                    @if ($menu->submenus->isNotEmpty())
                        <div class="item cursor-pointer py-2">
                            <a href="{{ __url($menu->slug) }}"
                                class="sub-btn flex justify-start items-center side_nav_gazette">{{ Str::upper($menu->menu_level) }}
                                        ...
                                        @foreach ($menu->submenus as $submenu)
                                            @if ($loop->iteration == 1)
                                                <a href="{{ __url($menu->slug) }}"
                                                    ...
                                                    class="sub-item block my-1 text-base hover:text-cyan-500 dark:hover:text-cyan-500 text-cyan-600 dark:text-cyan-500 transition_3">
                                                    {{ localize('all') }}
                                                </a>
                                            @endif
                    ...
                    @if ($allRssFeeds->count() > 1)
                        ...
                        <div class="item cursor-pointer py-2">
                            <a href="{{ __url('rss-news') }}"
                                class="sub-btn @if (!$themeSettings->text_color) text-white @endif flex justify-start items-center hover:transition_3 hover:text-red-600 active:text-red-600 side_nav_gazette"
                ...
                @if (isset($allVedioNews) && $allVedioNews->isNotEmpty())
                    <div class="item cursor-pointer py-2">
                        <a href="{{ __url('videos') }}"
                            class="sub-btn flex justify-start items-center side_nav_gazette">{{ Str::upper(localize('video')) }}
                ...
                <div class="item cursor-pointer py-2 relative">
                    <a class="sub-btn flex justify-start items-center side_nav_gazette">{{ Str::upper(localize('more')) }}
                    ...
                    <div
                        class="sub-menu max-h-0  overflow-hidden transition-max-height duration-300 ease-in-out bg-white dark:bg-neutral-800 absolute top-[calc(100%+4px)] left-0 w-max shadow-md z-99 dark:text-white">
                            ...
                            @foreach ($pageMenus as $page)
                                @if ($page->pagesubmenus->isNotEmpty())
                                    <li class="py-2 isolate relative overflow-hidden inner_menu">
                                        <div
                                            class="px-3 hover:text-cyan-500 transition_3 flex gap-3 justify-between items-center">
                                            {{ $page->menu_level }}
                                            <span class="rtl:scale-x-[-1]">
                                                <svg class="absolute lg:relative right-0 transition_3 lg:ml-1 rtl:lg:mr-1 rtl:lg:ml-auto dropdown"
                                                    width="16" height="16" xmlns="http://www.w3.org/2000/svg"
