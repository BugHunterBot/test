<footer class="relative w-full h-max isolate @if (!$themeSettings->footer_color || mode()) bg-theme-five-secondary @endif"
    @if (!mode() && $themeSettings->footer_color) style="background-color: {{ $themeSettings->footer_color }};" @endif>
    <div class="container py-8">
        @include ('themes.gazette.components.common.footer-heading')

        <section
            class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 xl:gap-0 border-y border-y-blue-950 py-8 lg:divide-x lg:divide-blue-950">
            <!--  {/* Address Section */} -->
