<section class="">
    ...
    <div class="grid grid-cols-2 gap-2">
        ...
        <a href="{{ $followUsLinks->fb->link }}" target="_blank"
            class="bg-social-facebook text-white flex items-center gap-2 px-2 py-4">
        ...
        <a href="{{ $followUsLinks->tw->link }}" target="_blank"
            class="bg-social-twitter text-white flex items-center gap-2 px-2 py-4">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a href="{{ $followUsLinks->instagram->link }}" target="_blank"
            class="bg-social-instragram text-white flex items-center gap-2 px-2 py-4">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a href="{{ $followUsLinks->linkd->link }}" target="_blank"
            class="bg-blue-600 text-white flex items-center gap-2 px-2 py-4">
        ...
        <a href="{{ $followUsLinks->pin->link }}" target="_blank"
            class="bg-red-700 text-white flex items-center gap-2 px-2 py-4">
        ...
        <a href="{{ $followUsLinks->youtube->link }}" target="_blank"
            class="bg-social-youtube text-white flex items-center gap-2 px-2 py-4">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
