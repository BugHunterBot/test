<section class="my-4 space-y-3 md:border dark:border-neutral-800 md:p-2 md:rounded-md">
    ...
    <a href="{{ __url($recommendedPosts[0]->encode_title) }}" class="bg_gradient_top block">
        <img class="w-full h-full object-cover"
            src="{{ isset($recommendedPosts[0]->photoLibrary->image_base_url) ? $recommendedPosts[0]->photoLibrary->image_base_url : asset('/assets/recommended-posts.png') }}"
