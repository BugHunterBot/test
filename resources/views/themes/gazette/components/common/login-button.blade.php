    ...
    @else
        ...
        <div class="flex divide-x rtl:divide-x-reverse">
            <button type="button" id="openModal"
                class="px-2 text-neutral-700 dark:text-white hover:text-cyan-500 dark:hover:text-cyan-500 transition_3">
                {{ localize('login') }}
            </button>
            <a href="{{ __url('registration') }}"
                class="pl-2 rtl:pl-0 rtl:pr-2 text-neutral-700 dark:text-white hover:text-cyan-500 dark:hover:text-cyan-500 transition_3">
