...
<div class="border-b border-blue-900 pb-4 overflow-x-auto overflow-y-hidden">
    <div class="divide-x divide-blue-900 rtl:divide-x-reverse flex">
        @foreach ($videoNews as $videoNewsItem)
            <!-- Card-1 -->
            <div class="px-2 2xl:px-3 xl:first:ps-0 xl:last:pr-0 py-4 lg:py-0 w-[320px] 2xl:w-[340px] 4xl:w-[360px]">
                <figure class="relative w-[300px] 2xl:w-[315px] 4xl:w-[325px] h-56 group overflow-hidden block">
