<div class="mb-4">
    <h2 class="text-theme-six-primary uppercase text-lg md:text-xl font-bold">
        widding
    </h2>
</div>
...
<div class="grid md:grid-cols-2 xl:grid-cols-2 gap-8">
    @foreach ($cards as $card)
        <!-- cart 1 -->
        <div class="">
            <a href="#" class="block w-full h-48 xl:h-64 3xl:h-72 group overflow-hidden">
                <img class="w-full h-full object-cover group-hover:scale-105 transition_slow"
                    src="{{ asset($card['image']) }}" alt="News Category Large" />
            </a>
