                    ...
                    <div class="accordion mt-4" id="changelogAccordion">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading-703">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-703" aria-expanded="true" aria-controls="collapse-703">
                                    <h6 class="mb-0">Version: <span class="badge bg-success">v7.0.3</span></h6>
                                </button>
                            </h2>
                            <div id="collapse-703" class="accordion-collapse collapse show" aria-labelledby="heading-703" data-bs-parent="#changelogAccordion">
