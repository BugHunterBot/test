                ...
                <div class="panel-body">
                  <div>
                      <table width="100%" class="table_boxnew" style="padding: 5px">
                        <tr>
                            <td colspan="3" align="center"><h2 style="margin: 0;">Cash Flow Statement  </h2></td>
                        </tr>
                        <tr class="table_head">
                        ...
                        <tr class="table_head">
                            ...
                            <td width="2%">&nbsp;</td>
                            <td width="30%" align="right" style="padding-left:10px; padding-right:10px;  border:1px solid #000;;"><b>Amount in Taka</b></td>
                        </tr>
                         <tr class="table_head">
