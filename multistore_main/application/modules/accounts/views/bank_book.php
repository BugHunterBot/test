                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select name="cmbCode" id="cmbCode" onchange="cmbCode_onchange()" class="form-control" style="width:255px;">
                        ...
                        <div class="form-group row">
                            <label for="date" class="col-sm-4 col-form-label"><?php echo display('account_code') ?>Account Code</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="date" class="col-sm-4 col-form-label"><?php echo display('from_date') ?>From Date</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="date" class="col-sm-4 col-form-label"><?php echo display('to_date') ?>To Date</label>
                            <div class="col-sm-8">
            ...
            <div class="panel-body"  id="printArea">
                ...
                <div class="">
                    <table width="100%" class="table_boxnew" cellpadding="1" cellspacing="1">
                        <tr>
                        <tr align="center">
                            <td colspan="7"><font size="+1" style="font-family:'Arial'"> <strong>Bank Book Report of <?php echo $HeadName ?> on <?php echo $FromDate; ?> To <?php echo $ToDate;?></strong></font><strong>
                            </th>
                            </strong></tr>
                        <tr  align="left">
                        ...
                        <tr class="table_head">
                            ...
                            <td align="right"><strong>VType</strong></td>
                            <td align="center"><strong>Head Of Account</strong></td>
                            <td width="11%" align="right"><strong>Debit</strong></td>
                            <td width="11%" align="right"><strong>Credit</strong></td>
