    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body"  id="printArea">
                <tr align="center">
                    <td id="ReportName" style="font:'Times New Roman', Times, serif; font-size:20px;"><b>Cash Book Voucher</b></td>
                </tr>
                <div>
                    ...
                    <table width="100%" class="table_boxnew" cellpadding="6" cellspacing="1" style="line-height:120%;">
                        <tr>
                        <tr align="center">
                            <td colspan="7"><font size="+1" style="font-family:'Arial'"> <strong>Cash Book Report of on <?php echo $FromDate; ?> To <?php echo $ToDate;?></strong></font><strong>
                            </th>
                            </strong></tr>
                        <tr  align="left">
                        ...
                        <tr class="table_head">
                            ...
                            <td align="center"><strong>VType</strong></td>
