            ...
            <div id="printArea">
                <div class="panel-body">
                  <table width="100%" class="table_boxnew" cellpadding="5" cellspacing="0">
                    <tr>
                        <td colspan="2" align="center" style="font-size:20px;"><b>Statement of Comprehensive Income<br/>From <?php echo $dtpFromDate ?> To <?php echo $dtpToDate;?></b></td>
                    </tr>
                    <tr>
                      <td width="85%" bgcolor="#E7E0EE" align="center" style="font-size:18px; border-left:solid 1px #000; border-top:solid 1px #000;">Particulars</td>
                      <td width="15%" bgcolor="#E7E0EE" align="center" style="font-size:18px; border-left:solid 1px #000; border-right:solid 1px #000;border-top:solid 1px #000;">Amount</td>
                    </tr>
                    <?php
                    for($i=0;$i<count($oResultAsset);$i++)
                    {
                          ...
                          <table width="100%" cellpadding="1" cellspacing="20">
                            <tr>
                              <td width="20%" style="border-top: solid 1px #000;" align="center">Prepared By</td>
                                ...
                                <td width="20%" style="border-top: solid 1px #000;" align="center">Authorized Signature</td>
