...
//approved
 ...
 //          $date=date('Y-m-d');
//          $this->db->select('VNo,Narration,Vtype,VDate,Debit,Credit');
//          $this->db->select_sum('(Debit+Credit)/2 as Amount');
//          $this->db->from('acc_transaction');
//          $this->db->where('VDate',$date);
//          $this->db->where('COAID',1020101);
//          $this->db->where('IsAppove',1);
//          $this->db->where_in('VType', array('DV','JV','CV'));
//          $this->db->group_start()
//              ->where('VNO', 'Narration', 'Vtype', 'VDate')
//              ->group_end();
//          $this->db->order_by('VDate', 'desc');
//          $query = $this->db->get();
//          return $query->result();
...
//        $this->db->where('COAID',1020101);
//        $this->db->where('IsAppove',1);
//        $this->db->where_not_in('VType', array('DV','JV','CV'));
//        $query = $this->db->get();
//        return $query->result();
