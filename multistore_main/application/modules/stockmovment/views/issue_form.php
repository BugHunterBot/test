    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?= form_open_multipart('stockmovment/stockmovment/issue') ?>
                    <?php echo form_hidden('movement_id', $move_data->movement_id) ?>
                         <div class="row" id="">
                            <div class="col-sm-4">
                ...
                $store=$this->db->select('*')->from('store')->where('store_id',$move_data->for_store_id)->get()->row(); echo $store->store_name;?>" class="form-control" readonly>
                                        <input type="hidden" name="for_store" value="<?php echo $move_data->for_store_id; ?>">
                                      <?php }?>
...
<input type="hidden" name="from_store" value="<?php echo $move_data->from_store_id;?>">
  <?php }?>
                             ...
                             <div class="col-sm-4">
                               <div class="form-group row">
                                   <label for="proposal_datetime" class="col-sm-4 col-form-label"><?php echo display('proposal_datetime') ?>
                                    ...
                                    <div class="col-sm-8">
                                      <input type="text" name="proposal_datetime" class="form-control " value="<?php echo $move_data->proposal_datetime; ?>" readonly>
                                    </div>
                    ...
                    <div class="row"> 
                        <div class="col-sm-4">
                               <div class="form-group row">
                         <label for="issue_code" class="col-sm-4 col-form-label"><?php echo display('issue_code') ?>
                                       
                                    </label>
                                    <div class="col-sm-8">
                                     <input type="text" name="issue_code" value="<?php echo  $issue_code; ?>" class="form-control">
                                    </div>
                                    </div>
                    </div>
                    <div class="col-sm-8">
                               <div class="form-group row">
                         <label for="remarks" class="col-sm-4 col-form-label"><?php echo display('remark') ?>
                                       
                                    </label>
                                    <div class="col-sm-8">
                                        <textarea name="remark" class="form-control" placeholder="<?php echo display('remark') ?>"></textarea>
                                ...
                                <thead>
                                    <tr>
                                            ...
                                            <th class="text-center"><?php echo display('proposal_qty') ?> <i class="text-danger">*</i></th>
                                             <th class="text-center"><?php echo display('issue_qty') ?> <i class="text-danger">*</i></th>
                                    ...
                                    <tr>
                                       ...
                                       <td class="wt">
                                            ...
                                            <td class="text-right">
                                             ...
                                             <td class="text-right">
                                               <input type="text"  id="quantity_<?php  echo $sl; ?>" class="form-control text-right "  placeholder="proposal quantity" value="<?php echo $details['proposal_qty'] ?>"  tabindex="8" required="required"/>
                    ...
                    <div class="form-group text-right">
                        ...
                        <button type="submit" id="add"class="btn btn-success w-md m-b-5"><?php echo display('send') ?></button>
                    </div>
                <?php echo form_close() ?>
     ...
     function checkboxcheck(sl){
        ...
        if($('#'+check_id).prop("checked") == true){
            ...
            document.getElementById(total_qntt).setAttribute("name","total_qntt[]");
             document.getElementById(propsal_qntt).setAttribute("name","prosal_qty[]");
        }
