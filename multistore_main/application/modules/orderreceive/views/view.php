<div class="row">
      ...
      <tr>
        <td align="left" valign="top"><table width="100%" border="1" cellpadding="2">
          ...
          <tr>
            ...
            <td align="right">Mr Atif Khan</td>
          </tr>
        </table></td>
  ...
  <?php 
   $details =  $this->db->select('product.*,purchase_order_details.*,store.*')
  ...
  <tr>
    ...
    <td align="center"><?php echo $details['unit'] ?></td>
    <td align="right"><?php echo $details['product_rate'] ?></td>
    <td align="right"><?php echo $details['discount'] ?></td>
    <td align="right"><?php echo $details['product_rate']*$details['order_qty']; ?></td>
  </tr>
  <?php     } ?>
  <tr>
  ...
  <tr>
    ...
    <td align="right"><?php echo $subquntity; ?></td>
    <td colspan="4" align="right"><?php echo $subtotal; ?></td>
    </tr>
  <tr>
    <td colspan="6">Discount Amount</td>
    <td colspan="2" align="right"><?php echo $total_dis; ?></td>
    </tr>
  <tr>
    <td colspan="6"><strong>Grand Total</strong></td>
    <td colspan="2" align="right"><strong><?php echo $subtotal-$total_dis;?></strong></td>
    </tr>
    <?php } ?>
      ...
      <tr>
        <td width="50%" valign="top"><table width="100%" border="1" cellpadding="2">
          ...
          foreach ($purchase_orders as $order_details) {
             ...
             $order_category_details =  $this->db->select('product.*,purchase_order_details.*,store.*,count(purchase_order_details.product_id) as row')
              ->from('purchase_order_details')
              ->join('store','purchase_order_details.store_id = store.store_id')
              ->join('product','purchase_order_details.product_id=product.product_id')
         ...
         ?>
          <tr>
            <td valign="top"><?php echo $category_details['category'] ?></td>
            <td valign="top"><?php echo $category_details['model'] ?></td>
          ...
          <tr>
            ...
            <td align="center" valign="top"><?php echo $total_qtys ?></td>
          </tr>
        </table></td>
        <td width="50%" valign="top">
          ...
          foreach ($purchase_orders as $order_detail) {
           ...
           $location_details =  $this->db->select('product.*,purchase_order_details.*,store.*,count(purchase_order_details.product_id) as row')
              ->from('purchase_order_details')
              ->join('store','purchase_order_details.store_id = store.store_id')
              ->join('product','purchase_order_details.product_id=product.product_id')
          ...
          <tr>
            ...
            <td><?php echo $location_information['category'] ?></td>
          ...
          <?php } ?>
            ...
            <td colspan="2" align="center" valign="top">Total</td>
            <td align="center" valign="top"><?php echo $total_qty_stowise; ?></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
