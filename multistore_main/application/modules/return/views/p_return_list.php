                ...
                <div class="">
                    <table class="datatable2 table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <?php $sl = 1; ?>
                            <?php foreach ($p_return as $return) { 
                                ?>
                            <tr>
                                <td><?php echo $sl++; ?></td>
                                ...
                                <?php if($this->permission->method('return','read')->access()): ?>
                                    <a href="<?php echo base_url("return/returns/purchase_return_view/$return->preturn_id") ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                <?php endif; ?>
