<style>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('update_lease') ?></h4>
                        </div>
                    </div>
   ...
   <?php echo form_open_multipart('lease/lease/lease_up_form',array('class' => 'form-vertical', 'id' => 'update_lease','name' => 'update_lease'))?>
                        ...
                        <div class="row" id="pakage_code">
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                     <input type="text" name="pakage_code" value="<?php echo $lease_info->package_code ?>" class="form-control" placeholder="<?php echo display('pakage_code')?>">
                                    </div>
                             ...
                             <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="pakage_name" value="<?php echo $lease_info->package_name ?>" class="form-control" placeholder="<?php echo display('pakage_name')?>">
                                        <input type="hidden" name="lease_id" value="<?php echo $lease_info->lease_id ?>">
                                    </div>
                    ...
                    <div class="row">
                          <table class="table table-bordered table-hover" id="saleTable">
                                ...
                                <tbody>
                                    <td> <input type="text" name="duration" value="<?php echo $lease_info->lease_duration ?>" class="form-control" placeholder="<?php echo display('duration')?>"></td>
                                    <td> <input type="text" name="advance" value="<?php echo $lease_info->advance*100 ?>" class="form-control" placeholder="<?php echo display('advance')?>"></td>
                                    <td> <input type="text" name="markup" value="<?php echo $lease_info->markup*100 ?>" class="form-control" placeholder="<?php echo display('markup')?>"></td>
                                </tbody>
                        </div>
        ...
        <button type='button' class="btn btn-danger btn-md" value='remove' id='rmvBtn' name='test' /><i class="fa fa-minus"></i></button></th>
       ...
       <i class="fa fa-plus"></i> 
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                     <td> 
                                     <span id="pr">
                                       <?php foreach ($prdmap as $prmp) {?>

        <input type="checkbox" id="<?php echo $prmp['product_id']?>" name="product_id[]" value="<?php echo $prmp['product_id']?>" checked="checked" /><label for="<?php echo $prmp['product_id']?>" id="<?php echo 'lbl_'.$prmp['product_id']?>"><?php echo $prmp['product_name']; ?></label><br id="<?php echo $prmp['product_id']; ?>">
                                    <?php    }  ?>
                                    ...
                                    <td><span id="st">
                                       ...
                                       <?php foreach ($strmap as $stm) {?>

       <input type="checkbox" id="<?php echo $stm['store_id']?>" name="store_id[]" value="<?php echo $stm['store_id']?>" checked="checked" /> <label for="<?php echo $stm['store_id']?>" id="<?php echo 'lbls_'.$stm['store_id']?>"><?php echo $stm['store_name']; ?></label><br id="strb_<?php echo $stm['store_id']; ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 text-right">
                                <input type="submit" id="add_sale" class="btn btn-primary btn-large" name="add-sale" value="<?php echo display('update') ?>" />
                        ...
                        <div class="panel">
                           <form id="p_ad">
                            ...
                            <input type="hidden" id="pr_<?php echo $product['product_id']?>" value="<?php echo $product['product_name']?>">
                                        <input type="checkbox" name="" value="<?php echo $product['product_id']?>" id="product_<?php echo $product['product_id']?>" class="prch"><label for="product_<?php echo $product['product_id']?>"></label><?php echo $product['product_name']?> <br><?php } ?>
                ...
                <div class="row">
                   ...
                   <form id="s_ad">
                            ...
                            <input type="hidden" id="st_<?php echo $store['store_id']?>" value="<?php echo $store['store_name']?>">
                                        <input type="checkbox" name="" id="stor_<?php echo $store['store_id']?>" class="strcheck" value="<?php echo $store['store_id']?>"><label for="stor_<?php echo $store['store_id']?>"><?php echo $store['store_name']?></label> <br><?php } ?>
...
<script type="text/javascript">
   ...
   if (ischecked) {
    ...
    var pr_name =$('#pr_'+ids).val();
          var Lab= "lbl_"+$(this).val();
          
           $("#pr").append('<input type="checkbox" id="'+$(this).val()+'" class="prdcheck" name="product_id[]" value="'+$(this).val()+'" /><label for="'+$(this).val()+'" id="'+Lab+'">'+pr_name+'</label><br id="lbls_'+$(this).val()+'">');
        $('#product').modal('hide');
        }
...
$("#st").append('<input type="checkbox" id="'+$(this).val()+'" name="store_id[]" value="'+$(this).val()+'" /><label for="'+$(this).val()+'" id="'+Labs+'">'+document.getElementById("st_"+$(this).val()).value+'</label><br id="strb'+$(this).val()+'">');

 //document.getElementById("st").innerHTML = checkbox_value;
 $('#stor').modal('hide');
   ...
   var rmvsTores = document.getElementsByName('store_id[]');
    ...
    for(var i = 0; i < rmvsTores.length; i++)
    {
        if(rmvsTores[i].checked)
        {
            ...
            var elems_id = 'strb_'+rmvsTores[i].id;
