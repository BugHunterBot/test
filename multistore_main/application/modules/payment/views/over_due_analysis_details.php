            ...
            <table class="datatable2 table table-bordered table-hover">
                <thead>
                   ...
                   <tr>
                    ...
                    <th><?php echo display('lease') ?>(<?php echo display('install_no') ?>)</th>
...
$information = $this->db->select('payment_collection.*,sales_parent.installment_amnt,sales_parent.package_price,lease.*,sales_parent.sales_date,sales_parent.invoice_no,customer.*,gurrantor.*,sales_parent.gurrantor_2')
                        ...
                        ->join('gurrantor','sales_parent.gurrantor_1 = gurrantor.gurrantor_id')
...
<tr>
    ...
    <td><table class="table table-bordered  table-hover"><tr>
    <td><?php echo $info['gurrantor_name']; ?></td></tr><tr>
    <td><?php $second_gurrantor = $this->db->select('*')->from('gurrantor')->where('gurrantor_id',$info['gurrantor_2'])->get()->row();
			echo $second_gurrantor->gurrantor_name;?></td></tr></table></td>
    <td><table class="table table-bordered"><tr><td><?php echo $info['gurrantor_phone']; ?><br><?php echo $info['gurrantor_address']; ?></td></tr><tr><td><?php echo $second_gurrantor->gurrantor_phone; ?><br><?php echo $second_gurrantor->gurrantor_address; ?></td></tr></table></td>
