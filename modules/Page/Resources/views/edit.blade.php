...
@section('title', ucwords(localize('update_page')))
@push('css')
    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ ucwords(localize('update_page')) }}</h6>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="table_customize">
                ...
                <form id="pageDetailsNonModalUpdateForm" action="{{ route('page.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                            ...
                                            <select name="language_id" id="language_id" class="form-control select-basic-single" required>
                                                @foreach ($languages as $language)
                                                    <option value="{{ $language->id }}" {{ $page->language_id == $language->id ? 'selected' : '' }}>
                                                        {{ $language->langname }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-md-4">
                                    <div class="row form-group">
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                            ...
                                            placeholder="{{ localize('video_url') }}" value="{{ old('video_url') ?? $page->video_url }}">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                            placeholder="{{ localize('title') }}" value="{{ old('title') ?? $page->title }}" required>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-12 col-md-12 col-xl-12" id="slug">
                                    ...
                                    <input type="text" class="form-control" name="slug"
                                            placeholder="{{ localize('page_slug') }}" value="{{ old('page_slug') ?? $page->page_slug }}">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="row form-group">
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    ...
                                    placeholder="{{ localize('details') }}" rows ="10" cols="80">{!! $page->description !!}</textarea>
                            ...
                            <div class="row form-group">
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    ...
                                    <label for="meta_keyword" class="col-form-label fw-semibold">{{ localize('meta_keyword') }}</label>
                                        ...
                                        <input type="text" id="tags" name="meta_keyword" class="form-control" data-role="tagsinput" value="{{$page->seo_keyword}}">
                                ...
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    ...
                                    <label for="meta_description" class="col-form-label fw-semibold">{{ localize('meta_description') }}</label>
                                        ...
                                        <textarea  class="form-control" name="meta_description"
                                            placeholder="{{ localize('meta_description') }}" rows ="5">{{$page->seo_description}}</textarea>
...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            console.log(CKEDITOR.plugins.get('removeSandbox'));
        });
